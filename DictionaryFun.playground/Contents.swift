...
var statesAndCapitals : [String : String]=["New York":"Albany",
                                           "Ohio":"Columbus",
                                           "Florida":"Tallahassee",
                                           "Georgia":"Atlanta",
                                           "Kentucky":"Frankfort"]
...
statesAndCapitals["New York"]
print ("The capital of \(state) is \( statesAndCapitals["New York"])")
...
var bandsAndMembers = ["Nirvana" : ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
                                               "The Beatles": ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
                                              "The Breeders": ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
                                                                   "Pixies" : ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]]
...
//Key of Strings and Values of Array of Strings
...
if let bandMembers = bandsAndMembers[bandName] {
